...
public class NativeInput extends haxe.io.Input
{
	...
	{
		//line 30 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
	...
	{
		//line 33 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		haxe.java.io.NativeInput.__hx_ctor_haxe_java_io_NativeInput(this, stream);
	}
	
	
	public static void __hx_ctor_haxe_java_io_NativeInput(haxe.java.io.NativeInput __temp_me20, java.io.InputStream stream)
	{
		//line 35 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		__temp_me20.stream = stream;
	}
	...
	{
		//line 40 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		int ret = 0;
		//line 43 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		try 
		{
			//line 43 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		...
		{
			//line 46 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		...
		//line 48 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		if (( ret == -1 )) 
		{
			//line 49 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
			throw haxe.lang.HaxeException.wrap(new haxe.io.Eof());
		}
		
		//line 50 "/usr/local/lib/haxe/std/java/io/NativeInput.hx"
		return ret;
	}

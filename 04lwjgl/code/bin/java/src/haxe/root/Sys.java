...
public class Sys extends haxe.lang.HxObject
{
	...
	{
		//line 34 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 39 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	public static haxe.root.Array<java.lang.String> args()
	{
		...
		boolean tmp = ( haxe.root.Sys._args == null );
		//line 44 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (tmp) 
		{
			//line 45 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return new haxe.root.Array<java.lang.String>(new java.lang.String[]{});
		}
		
		//line 46 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 51 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 57 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 62 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		boolean tmp = ( haxe.root.Sys._env != null );
		//line 62 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (tmp) 
		{
			//line 63 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return ((haxe.ds.StringMap<java.lang.String>) (haxe.root.Sys._env) );
		}
		
		//line 64 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		haxe.ds.StringMap<java.lang.String> _env = haxe.root.Sys._env = new haxe.ds.StringMap<java.lang.String>();
		//line 65 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		{
			//line 65 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			java.util.Iterator<java.util.Map.Entry<java.lang.String, java.lang.String>> tmp1 = java.lang.System.getenv().entrySet().iterator();
			//line 65 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			while (tmp1.hasNext())
			{
				//line 65 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
				java.util.Map.Entry<java.lang.String, java.lang.String> mv = tmp1.next();
				//line 67 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
				_env.set(mv.getKey(), mv.getValue());
			}
			
		}
		
		//line 70 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 76 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		try 
		{
			//line 76 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		...
		catch (java.lang.Throwable __temp_catchallException1)
		{
			...
			//line 78 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 83 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		return false;
	}
	...
	{
		//line 88 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 94 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 99 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		boolean tmp = ( haxe.root.Sys._sysName != null );
		//line 99 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (tmp) 
		{
			//line 99 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		...
		//line 100 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		java.lang.String sname = java.lang.System.getProperty(haxe.lang.Runtime.toString("os.name")).toLowerCase();
		//line 101 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		int tmp1 = haxe.lang.StringExt.indexOf(sname, "win", null);
		//line 101 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (( tmp1 >= 0 )) 
		{
			//line 102 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return haxe.root.Sys._sysName = "Windows";
		}
		
		//line 103 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		int tmp2 = haxe.lang.StringExt.indexOf(sname, "mac", null);
		//line 103 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (( tmp2 >= 0 )) 
		{
			//line 104 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return haxe.root.Sys._sysName = "Mac";
		}
		
		//line 105 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		int tmp3 = haxe.lang.StringExt.indexOf(sname, "nux", null);
		//line 105 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (( tmp3 >= 0 )) 
		{
			//line 106 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return haxe.root.Sys._sysName = "Linux";
		}
		
		//line 107 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		int tmp4 = haxe.lang.StringExt.indexOf(sname, "nix", null);
		//line 107 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		if (( tmp4 >= 0 )) 
		{
			//line 108 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return haxe.root.Sys._sysName = "BSD";
		}
		
		//line 110 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 114 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		try 
		{
			//line 115 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			java.lang.ProcessBuilder pb = sys.io.Process.createProcessBuilder(cmd, args);
			//line 117 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			pb.redirectErrorStream(((boolean) (true) ));
			//line 122 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			java.lang.Process proc = pb.start();
			//line 124 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			haxe.java.io.NativeInput reader = new haxe.java.io.NativeInput(((java.io.InputStream) (proc.getInputStream()) ));
			//line 127 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			try 
			{
				//line 127 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
				while (true)
				{
					//line 128 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
					java.lang.String ln = reader.readLine();
					//line 129 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			...
			//line 134 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			proc.waitFor();
			//line 135 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			int exitCode = proc.exitValue();
			//line 136 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			proc.destroy();
			//line 137 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			return exitCode;
		}
		catch (java.lang.Throwable typedException)
		{
			//line 113 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 142 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 147 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 152 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 157 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 161 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		try 
		{
			//line 161 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		...
		{
			//line 160 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
			throw haxe.lang.HaxeException.wrap(typedException);
		}
	...
	{
		//line 170 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
		throw haxe.lang.HaxeException.wrap("Not implemented");
	}
	...
	{
		//line 181 "/usr/local/lib/haxe/std/java/_std/Sys.hx"
	...
	{
		//line 186 "/usr/local/lib/haxe/std/java/_std/Sys.hx"

...
public class Input extends haxe.lang.HxObject
{
	...
	{
		//line 175 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		haxe.root.StringBuf buf = new haxe.root.StringBuf();
		//line 176 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		int last = 0;
		//line 177 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		java.lang.String s = null;
		//line 178 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		try 
		{
			//line 179 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			while (true)
			{
				//line 179 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				last = this.readByte();
				...
				//line 180 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				buf.addChar(last);
			}
			
			//line 181 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			s = buf.toString();
			//line 182 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		...
		catch (java.lang.Throwable __temp_catchallException1)
		{
			...
			//line 183 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
			...
			if (( __temp_catchall2 instanceof haxe.io.Eof )) 
			{
				...
				//line 183 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
				{
					//line 184 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					s = buf.toString();
					//line 185 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
					if (( s.length() == 0 )) 
					{
						//line 186 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		...
		//line 188 "/usr/local/lib/haxe/std/haxe/io/Input.hx"
		return s;
	}
